...
if game.PlaceId == 16732694052 then 
    ...
    local Window = Fluent:CreateWindow({
        Title = "🐟 Fisch",
        SubTitle = "by YuongzMin (Beta) UPD|04/11/25 06:40",
        TabWidth = 160,
    ...
    do -- no delete
        Fluent:Notify({
            ...
            SubContent = "Script Update 04/11/25 06:40",
            Duration = 10
        })
        ...
        IdentityHiderUI:OnChanged(function()
            while Options.IdentityHiderUI.Value == true do
                if UserPlayer:FindFirstChild("streak") then UserPlayer.streak.Text = "SkidderHub Script Free | https://discord.gg/yaJmBp2brg" end
                if UserPlayer:FindFirstChild("level") then UserPlayer.level.Text = "Level: 9999999" end
                if UserPlayer:FindFirstChild("level") then UserPlayer.user.Text = "SkidderHub" end
    ...
    InterfaceManager:SetFolder("SKIDDERHUB")
    SaveManager:SetFolder("SKIDDERHUB2025/Fisch")
